      ...
      <v-flex>
            <v-window v-model="window" class="elevation-1" vertical>
                ...
                <!--<v-text-field v-model="search" append-icon="search" label="Search" single-line hide-details></v-text-field>-->
                    ...
                    <table-component ref="table" :headers="boardHeader" :page-req="getPage_board"
...
<script>
    module.exports = {
        ...
        methods: {
            ...
            addBoard: function () {
                let _this = this;
                router.push(`/sites/write/${_this.id}/${_this.siteId}/${_this.projectId}/0`);
            },
            clickBoard: function (item) {
                let _this = this;
                router.push(`/sites/write/${_this.id}/${_this.siteId}/${_this.projectId}/${item.boardId}`);
            },
